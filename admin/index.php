  ...
  ?>
   <tr>
                    ...
                    <td>
                      <div class="d-flex">
                        <div>
                          <img src="../assets/images/Verification/<?=$user['docfile']?>" class="rounded-circle border border-2 shadow-sm mx-2" width="55px" height="55px" />
                        </div>
                        <div>
                          <h5><?=$user['fname'].' '.$user['lname']?> - <span class="text-muted">@<?=$user['uname']?></span></h5>
                    ...
                    <td>
                      ...
                      <button style="display:<?=$user['verification']=="Verified"?'':'none'?>" class="m-1 btn btn-danger btn-sm unverified_btn ub" data-user-id="<?=$user['id']?>">Unverified</button>
                        <button style="display:<?=$user['verification']=="Unverified"?'':'none'?>" class="m-1 btn btn-primary btn-sm verified_btn" data-user-id="<?=$user['id']?>">Verified</button>
                           </td>
                  </tr>
  <?php
  $count++;
