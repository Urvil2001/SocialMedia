...
foreach($posts as $post){
    ...
    $username_post=getVerifiedDetailsOfPost($post['user_id']);
    ...
    ?>
     <div class="card mt-4">
                <div class="card-title d-flex justify-content-between  align-items-center">
                    <?php
                            if($username_post['verification']=='verified')
                            {
                     ?>
                        ...
                        <img src="assets/images/profile/<?=$post['profile_pic']?>" alt="" height="30" width="30" class="rounded-circle border">&nbsp;&nbsp;<a href='?u=<?=$post['username']?>' class="text-decoration-none text-dark"><div style="color: blue" ><?=$post['first_name']?> <?=$post['last_name']?></div></a>
    ...
    <?php
        ...
        <div class="col-lg-4 col-sm-0 overflow-hidden mt-4 p-sm-0 p-md-3">
            ...
            <div class="d-flex align-items-center p-2">
                ...
                { ?>
                    <div class="d-flex flex-column justify-content-center">
                <a href='?u=<?=$user['username']?>' class="text-decoration-none text-dark"><h6 style="margin: 0px;color: blue;"><?=$user['first_name']?> <?=$user['last_name']?></h6></a>
...
<div class="d-flex justify-content-between">
                    <div class="d-flex align-items-center p-2">
                        <?php if($suser['verification']=="verified")
                        { ?>
                        <div><img src="assets/images/profile/<?=$suser['profile_pic']?>" alt="" height="40" width="40" class="rounded-circle border"> 
                        </div>
                        <div>&nbsp;&nbsp;</div>
                        <div class="d-flex flex-column justify-content-center">
                            <a href='?u=<?=$suser['username']?>' class="text-decoration-none text-dark"><h6 style="margin: 0px;font-size: small;color: blue"><?=$suser['first_name']?> <?=$suser['last_name']?></h6></a>
