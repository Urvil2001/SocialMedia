...
if(isset($_GET['addcomment'])){
    ...
    $badword=['asshole','fuck','buttface','Go to hell','Bastard','Bitch'];
    $goodword=['blackhole','f**k','cuteface','Go to heaven','Ba****d','B**ch'];

    $comment=str_ireplace($badword, $goodword, $comment);
...
$users="";
    if(count($data)>0){
       ...
       if($fuser['verification']=='verified')
       { 
       $users.=' <div class="d-flex justify-content-between">
                            <div class="d-flex align-items-center p-2">
                                ...
                                <div>&nbsp;&nbsp;</div>
                                <div class="d-flex flex-column justify-content-center">
                                    <a href="?u='.$fuser['username'].'" class="text-decoration-none text-dark"><h6 style="margin: 0px;font-size: small;color:blue">'.$fuser['first_name'].' '.$fuser['last_name'].'</h6></a>
